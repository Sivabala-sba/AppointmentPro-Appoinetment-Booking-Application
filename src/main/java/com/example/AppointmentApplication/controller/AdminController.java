...
import com.example.AppointmentApplication.service.AdminDoctorService;
...
public class AdminController {
    ...
    @CrossOrigin
    public ResponseEntity<Doctor> registerDoctor(@RequestParam String key, @RequestBody Doctor doctor) throws DoctorException, LoginException {
