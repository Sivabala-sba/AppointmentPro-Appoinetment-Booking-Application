...
import com.example.AppointmentApplication.service.PatientService;
...
public class PatientController {
    ...
    @CrossOrigin
    public ResponseEntity<List<Appointment>> getAllAppointmentPatientWise(@RequestParam String key) throws AppointmentException, PatientException, LoginException{
        if(loginService.checkUserLoginOrNot(key)) {
